...
let products = [
    {
        name: ' St Michael from Mark&Spencer',
        tag: 'stmichaelfrommark&spencer',
        price: 15,
        inCart: 0
    }, {
        name: 'floral Shirt',
        ...
        name: 'Morgan&Donavan shirt',
        tag: 'morgan&donavanshirt',
        price: 17,
        inCart: 0
    },{
        name: 'basic line shirt',
        tag: 'basiclineshirt',
        price: 17,
        inCart: 0
    },{
  ...
  function manageQuantity() {
    ...
    for (let i = 0; i < increaseButtons.length; i++) {
      ...
      increaseButtons[i].addEventListener('click', () => {
        ...
        localStorage.setItem('producstInCart', JSON.stringify(cartItems));
        displayCart();
      })

...
let products = [
    {
        name: 'BIYUELAN Unisex Puffer Jacket',
        tag: 'biyuelanunisexpufferjacket',
        price: 15,
        inCart: 0
    }, {
        name: 'Embassy Of bricks And Logs Long Puffer Jacket',
        tag: 'embassyofbricksandlogslongpufferjacket',
        price: 17,
        inCart: 0
    }, ]
